...
class _TransactionListViewState extends State<TransactionListView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Transactions", style: TextStyle(fontFamily: 'Manrope', fontWeight: FontWeight.bold, color: Colors.white)),
        backgroundColor: Colors.transparent,
        elevation: 0,
        actions: [
          IconButton(
                    ...
                    itemBuilder: (context, index) {
                      if (index == transactionProvider.transactions.length) {
                        return const Padding(
                          ...
                          child: Center(child: CircularProgressIndicator(color: Color(0xFF147D64))),
                        );
                      }
                          ...
                          child: Row(
                            children: [
                              CircleAvatar(
                                ...
                                child: Icon(_getCategoryIcon(t.category.name), color: Colors.white, size: 18),
                              ),
                              ...
                              const SizedBox(width: 12),
                              Text(
                                "${isExpense ? '-' : '+'}${t.amount.toStringAsFixed(0)} LKR",
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: isExpense ? const Color(0xFFCD5C52) : const Color(0xFF147D64),
                                ),
                              ),
                            ],
                          ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text("Filters", style: TextStyle(fontFamily: 'Manrope', fontSize: 18, fontWeight: FontWeight.bold, color: Colors.white)),
                TextButton(onPressed: _reset, child: const Text("Reset All", style: TextStyle(color: Colors.white54))),
              ],
            ),
            ...
            DropdownButtonFormField<int>(
              ...
              items: [
                ...
                ...p.categories.map((c) => DropdownMenuItem<int>(value: c.id, child: Text(c.name)))
              ],
              onChanged: (val) {
            ...
            // Date Range
            ListTile(
              title: const Text("Date Range", style: TextStyle(color: Colors.white70)),
              subtitle: Text(
              ...
              trailing: const Icon(Icons.date_range_rounded, color: Colors.white70),
            ...
            ElevatedButton(
              ...
              child: const Text("Apply Filters", style: TextStyle(fontFamily: 'Manrope', fontSize: 15, fontWeight: FontWeight.bold)),
            ),
          ],
        ),
      ),
